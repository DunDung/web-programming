...
<div class="container">
    ...
    <form method="post">
        ...
        <div>
            <label>학번</label>
            <input type="text" class="text" name="studentNo" value="${ student.studentNo }"/>
        </div>
        <div>
            <label>이름</label>
            <input type="text" class="text" name="name" value="${ student.name }"/>
        </div>
        <div>
            <label>이메일</label>
            <input type="email" class="text" name="email" value="${ student.email }"/>
        </div>
        <div>
            <label>전공</label>
        ...
        <button type="submit" class="btn">학생정보등록</button>
    </form>
